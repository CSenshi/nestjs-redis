...
describe('RedisClientModule Integration', () => {
  ...
  describe('Real Redis Connection', () => {
	...
	it('should handle connection lifecycle', async () => {
	  // Test that the connector service properly manages the connection
  ...
  describe('Module Configuration', () => {
	it('should work with default configuration', async () => {
	  ...
	  const defaultRedisClient = defaultModule.get<Redis>(getRedisClientInjectionToken());
	...
	it('should work with custom URL configuration', async () => {
	  ...
	  const customRedisClient = customModule.get<Redis>(getRedisClientInjectionToken());
